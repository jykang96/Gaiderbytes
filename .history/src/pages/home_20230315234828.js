  ...
  return (
    <div>
        <div className='w-full h-auto bg-[#E2E8F0] mt-[64px] flex flex-col items-center rounded-[64px]'>
            ...
            <button className="mt-[48px] mb-[32px] px-[16px] py-[8px] font-[600] text-[24px] border border-black rounded-[4px] hover:text-white hover:bg-[#34345c] transition-colors duration-300">
                Apply Now
            </button>
        </div>
    </div>
