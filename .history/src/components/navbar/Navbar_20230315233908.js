  ...
  return (
    <div className="px-[10%] h-[75px] w-full bg-white fixed top-0 z-10 shadow-md">
        <div className="flex flex-row items-center h-full justify-between">
            ...
            <button className="btn_primary h-[42px] px-[16px] bg-[#E2E8F0] font-[600] text-[16px] text-[#172E38] rounded-[2px] hover:bg-[#34345c] hover:text-white transition-colors duration-300" onClick={()=>{navigate("/student-application")}}>
                Apply Now
            </button>
        </div>
    </div>
